...
function Home() {
  return (
    <div id='home' className='relative h-full w-full bg-skin-primary overflow-hidden'>
      ...
      <div className="h-1/5 bg-skin-secondary w-1 ml-16 sm:ml-8 absolute bottom-0 z-[2]" data-aos="fade-top" data-aos-delay="300"></div>
      <div className='absolute bottom-36 ml-13 sm:ml-5 z-10 sm:bottom-56'>
      ...
      <div className="w-full h-dvh flex justify-center items-end md:flex-col-reverse relative z-[2]">
        ...
        <div className='w-1/2 md:w-full h-full md:h-1/2 flex justify-end md:justify-center' >
          <div className='flex flex-col justify-center items-start md:justify-center md:items-center pr-20 sm:pr-0'>
            <div className='ml-6 mb-5 flex flex-col relative' data-aos="fade-right" data-aos-delay="400">
            ...
            <span className='text-skin-secondary text-6xl md:text-4xl pb-3 sm:pb-10' data-aos="fade-right" data-aos-delay="500">Mahesh Chavda</span>
            <span className='text-skin-secondary text-left font-semibold text-xl' data-aos="fade-right" data-aos-delay="600">I am Software Engineer and<br />I build the things for web.</span>
          </div>
        </div>
        {/* Image */}
