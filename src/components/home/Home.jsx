...
function Home() {
  return (
    <div id='home' className='relative h-full w-full bg-skin-primary overflow-hidden'>
      ...
      <div className='absolute bottom-36 ml-13 z-10 md:bottom-52 custom-hidden'>
      ...
      <div className="w-full h-dvh flex justify-center items-end md:flex-col-reverse relative z-[2]">
        ...
        <div className='w-1/2 md:w-full h-full md:h-1/2 flex justify-end'>
          <div className='flex flex-col justify-center items-start md:items-center pr-20 md:pr-auto'>
            <div className='ml-10 mb-5 flex flex-col relative custom-hidden'>
            ...
            <span className='md:w-1/2 text-skin-secondary text-6xl md:text-4xl pb-3 custom-hidden'>Mahesh Chavda</span>
            <span className='md:w-1/2 text-skin-secondary text-center font-semibold text-xl md:ml-18 custom-hidden'>I am Software Engineer and<br />I build the things for web.</span>
          </div>
        </div>
        {/* Image */}
        <div className='relative w-1/2 md:w-full h-full md:h-1/2 flex justify-end md:justify-end items-start md:items-center flex-col overflow-hidden'>
          <img className='w-3/5 md:w-2/3 drop-shadow-custom custom-hidden' src="/images/ProfessionalPhoto@2x.png" alt="logo" />
