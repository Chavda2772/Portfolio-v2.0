    ...
    <div id='home' className='relative h-full w-full bg-skin-primary overflow-hidden'>
      ...
      <div className='absolute bottom-1/4 ml-13 sm:ml-5 z-10 sm:bottom-56'>
        <a href='https://github.com/chavda2772' target='_blank'>
          <FaGithub className="text-3xl mb-3 cursor-pointer fill-skin-secondary hover:fill-skin-action animate-pulse" data-aos="fade-right" />
        </a>
        <a href='https://www.instagram.com/_mahesh_ahir_' target='_blank'>
          <AiFillInstagram className="text-3xl mb-3 cursor-pointer fill-skin-secondary hover:fill-skin-action animate-pulse" data-aos="fade-right" data-aos-delay="100" />
        </a>
        <a href='https://twitter.com/Mahesh_277' target='_blank'>
          <BsTwitterX className="text-3xl mb-3 cursor-pointer fill-skin-secondary hover:fill-skin-action animate-pulse" data-aos="fade-right" data-aos-delay="200" />
        </a>
        <a href='https://www.linkedin.com/in/mahesh-chavda/' target='_blank'>
          <FaLinkedinIn className="text-3xl cursor-pointer fill-skin-secondary hover:fill-skin-action animate-pulse" data-aos="fade-right" data-aos-delay="300" />
        </a>
      </div>
      <div className="w-full h-dvh flex justify-center items-end md:flex-col-reverse relative z-[2]">
        ...
        <div className='w-1/2 md:w-full h-full md:h-1/2 flex justify-end md:justify-center' >
          <div className='flex flex-col justify-center items-start md:justify-start sm:pt-8 md:items-center sm:pr-0'>
            <div className='ml-6 sm:ml-2 mb-5 flex flex-col relative animate-bounce' data-aos-delay="400">
